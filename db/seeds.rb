...
[
  ["KEY-001", "Production SDK integration", "agev_live_demo_7f91", "agev_live_...7f91", "Active", "2026-08-14 21:04:21", ["evidence:create", "evidence:read", "evaluations:read", "reviews:read", "program_profiles:read", "statements:read", "statements:share", "schemas:read", "source_records:create", "source_records:read"]],
  ["KEY-002", "Verifier sandbox", "agev_test_demo_2a10", "agev_test_...2a10", "Active", "2026-08-14 21:04:20", ["statements:read", "artifacts:read", "artifacts:verify", "schemas:read"]]
